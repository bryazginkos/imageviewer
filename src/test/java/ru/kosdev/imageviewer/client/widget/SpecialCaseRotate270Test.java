 ...
 */
public class SpecialCaseRotate270Test {
    ...
    public void testIdentityToVisibleTopWhenZeroAxis() {
        int calculatedVisibleTop = getVisibleTop(Rotation.ROTATION_270, 0, 0, cssTop);
        assertEquals(cssTop, calculatedVisibleTop);
    }

    @Test
    public void testIdentityToCssTopWhenZeroAxis() {
        int calculatedCssTop = getCssTop(Rotation.ROTATION_270, 0, 0, visibleTop);
        assertEquals(visibleTop, calculatedCssTop);
    }

    @Test
    public void testIdentityToVisibleLeftWhenZeroAxis() {
        int calculatedVisibleLeft = getVisibleLeft(Rotation.ROTATION_270, 0, 0, cssLeft);
        assertEquals(cssLeft, calculatedVisibleLeft);
    }

    @Test
    public void testIdentityToCssLeftWhenZeroAxis() {
        int calculatedCssLeft = getCssLeft(Rotation.ROTATION_270, 0, 0, visibleLeft);
    ...
    public void testToVisibleTopWhenOnlyXAxis() {
        int calculatedVisibleTop = getVisibleTop(Rotation.ROTATION_270, axisX, 0, cssTop);
        assertEquals(cssTop + axisX, calculatedVisibleTop);
    }

    @Test
    public void testToVisibleTopWhenOnlyYAxis() {
        int calculatedVisibleTop = getVisibleTop(Rotation.ROTATION_270, 0, axisY, cssTop);
        assertEquals(cssTop + axisY, calculatedVisibleTop);
    }

    @Test
    public void testToVisibleLeftWhenOnlyXAxis() {
        int calculatedVisibleLeft = getVisibleLeft(Rotation.ROTATION_270, axisX, 0, cssLeft);
        assertEquals(cssLeft + axisX, calculatedVisibleLeft);
    }

    @Test
    public void testToVisibleLeftWhenOnlyYAxis() {
        int calculatedVisibleLeft = getVisibleLeft(Rotation.ROTATION_270, 0, axisY, cssLeft);
